...
async def show_all_goods():
    all_goods = outerwears + underwears + footwears
    keyboard = InlineKeyboardBuilder()
    for good in all_goods:
        keyboard.add(InlineKeyboardButton(text=good, callback_data=f'all_{good}'))
    keyboard.add(InlineKeyboardButton(text='◀️', callback_data='to_main'))
