...
def load_or_parse_products():
    all_products_file_path = 'products.json'
    outwear_products_file_path = 'outwear_products.json'
    underwear_products_file_path = 'underwear_products.json'
    footwear_products_file_path = 'footwear_products.json'

    if os.path.exists(all_products_file_path):
        with open(all_products_file_path, 'r', encoding='utf-8') as file:
    ...
    with open(all_products_file_path, 'w', encoding='utf-8') as file:
        json.dump(products, file, ensure_ascii=False, indent=4)

    with open(outwear_products_file_path, 'w', encoding='utf-8') as file:
        json.dump(outwear_products, file, ensure_ascii=False, indent=4)

    with open(underwear_products_file_path, 'w', encoding='utf-8') as file:
        json.dump(underwear_products, file, ensure_ascii=False, indent=4)

    with open(footwear_products_file_path, 'w', encoding='utf-8') as file:
        json.dump(footwear_products, file, ensure_ascii=False, indent=4)


load_or_parse_products()
